...
function Icons() {
    ...
    const icons = [
        { 
            url: "https://www.linkedin.com/in/rkwarfield/",
            label: "linkedin",
            path: LINKEDIN_PATH,
        },
        {
            url: "https://github.com/kyteware",
            label: "github",
            path: GITHUB_PATH,
        }
    ]
...
function Icon({ url, label, path }: IconData) {
    ...
    return <a
        ...
        aria-label={label}
        className={"iconBoxIcon " + (hovered ? "iconHovered" : "iconNotHovered")}
